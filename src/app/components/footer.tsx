          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                ...
                >
                  <ChevronRight className="h-4 w-4 mr-2 text-blue-500 group-hover:translate-x-1 transition-transform duration-300" />
                  Home
                </button>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">123 Security Avenue, Tech City, 54321</span>
              </li>
              <li className="flex items-start">
                <div className="mr-3 mt-1 w-8 h-8 rounded-full flex items-center justify-center bg-gradient-to-br from-blue-600/20 to-purple-600/20 border border-blue-500/30">
